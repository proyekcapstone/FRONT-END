...
class HotelTerbaruPage extends StatelessWidget {
  static const routeName = 'hotel-terbaru-page';

  final HotelResult hotel;
  const HotelTerbaruPage({Key key, this.hotel}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hotel Terbaru'),
        centerTitle: true,
      ),
      body: SafeArea(
