...
class DestinationRekomendasiPage extends StatelessWidget {
  static const routeName = 'destination-rekomendasi-page';

  final DestinationResult destination;
  const DestinationRekomendasiPage({Key key, this.destination})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rekomendasi Destinasi'),
        centerTitle: true,
      ),
      body: SafeArea(
                    ...
                    return Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var random = Random()
                              .nextInt(state.result.destinations.length);
