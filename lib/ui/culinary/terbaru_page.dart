...
class CulinaryTerbaruPage extends StatelessWidget {
  static const routeName = 'culinary-terbaru-page';

  final CulinaryResult culinary;
  const CulinaryTerbaruPage({Key key, this.culinary}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kuliner Terbaru'),
        centerTitle: true,
      ),
      body: SafeArea(
